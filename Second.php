			...
			<div class="wrapper2">
				...
				<div class="container" style="background:#FFFFFF;border:1px rgb(4,24,44) solid;);border-radius:10px;padding:20px 10px 20px 10px ;">
					<table align="center">
						...
						<tr>
							<td colspan="2"><h1 class="center reg_head">Login for Second Year Studen</h1></td>
						</tr>
						...
						<form method="post" action="" id="login_form" name="login_form">
							  <table border="0" style="border:none">
								...
								<tr>
									...
									<td><label><a href="reg2.php" style="color:#; text-decoration:none" id="blink">Update Branch</a></label></td>
								</tr>
								<tr>
