...
<div class="main">
			...
			<div class="wrapper2">
				...
				<div class="container" style="background:#FFFFFF;border:1px rgb(4,24,44) solid;);border-radius:10px;padding:20px 10px 20px 10px ;">
					...
					<table align="center">
						...
						<tr>
							<td colspan="2"><h1 class="center reg_head">remove notification</h1></td>
						</tr>
 ...
 ?>
 <tr><td ><input type="text" tabindex="1"  placeholder="notification to remove" name="notice" class="inputtext radius1" value=""></td></tr>
								  <tr><td ><input type="submit" class="fbbutton radius1" name="remove" value="remove" /></td></tr>
 <tr><td><a href="admin2.php">back</a></td></tr>
 <tr>
