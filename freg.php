...
else
{
							...
							$sql=mysql_query("SELECT * FROM first WHERE id='".$id."'");
							if(mysql_num_rows($sql)!=0)
								...
								$query = "INSERT INTO first VALUES ('$st_name','$fa_name','$branch','$gender','$category','$s_type','$id','$email_id','$password')";
								...
								$query2 = "INSERT INTO student_info VALUES ('$id','$st_name','','---','')";
