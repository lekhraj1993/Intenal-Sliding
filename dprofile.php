		...
		<div class="main">
			...
			<div class="wrapper2">
				...
				<div class="container" style="background:#FFFFFF;border:1px rgb(4,24,44) solid;);border-radius:10px;padding:20px 10px 20px 10px ;">
					...
					<?php
					include("db.php");
					$sql=mysql_query("select * from diploma where id='".$_SESSION['login_user']."'", $link);
						...
						<form method="get" action="form.php">
							<table align="center">
								...
								<tr>
									  ...
									  <td colspan="3" align="center"><h3><a style="text-decoration:none;" href="confirm3.php">conferm registration of semester <?=$sem ?></a></h3></td> 
								...
								<tr>
									...
									<td id="td2"><?php echo strtoupper($_SESSION['login_user']); ?></td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2"><h3><a href="editprof3.php">Edit ur Profile</a></h3></td>
								</tr>
